...
def menu():
    ...
    with open("opcoes_menu.txt", encoding="utf-8") as msg:
        ...
        def depositar(saldo: float, valor: float, extrato: str, /):
            ...
            Returns:
            (Tuple[float, str]): Tupla contendo saldo e extrato do cliente, respectivamente."""
            ...
            if valor > 0:
                ...
                print("\nDepósito realizado com sucesso!")
                    ...
                    excedeu_saques: bool = numero_saques >= 
                    LIMITE_SAQUES
                                                ...
                                                def criar_usuario(usuarios: List):
                                                    ...
                                                    if usuario:
                                                        ...
                                                        def criar_conta(agencia: str, numero_conta: str, usuarios: List):
                                                            ...
                                                            Returns:
                                                            Union[Dict, None]: Dicionário contendo dados do usuário caso haja sucesso. None caso falhe."""
                                                                                ...
                                                                                valor: float = float(input("Informe o valor do depósito: "))
                                                                                    ...
                                                                                    try:
                                                                                        valor: float = float(input("Informe o valor do saque: "))
                                                                                            ...
                                                                                            case "cc":
                                                                                            conta: Union[Dict, None] = criar_conta(AGENCIA, numero_conta, usuarios)
